...
DISCORD_LEADERBOARD_CATEGORY_ID = os.getenv("DISCORD_LEADERBOARD_CATEGORY_ID")
DISCORD_DEBUG_LEADERBOARD_CATEGORY_ID = os.getenv("DISCORD_DEBUG_LEADERBOARD_CATEGORY_ID")
